...
import { ClickAwaySurface } from "@/components/ui/ClickAwaySurface";
          ...
          <Box sx={{ position: "relative", flex: 1, overflow: "hidden" }}>
                    ...
                    <Stack spacing={0.5} alignItems="flex-end">
                      ...
                      <Stack direction="row" spacing={0.5} alignItems="center">
                        <IconButton
                          ...
                          onClick={() =>
                            items ? undefined : cart.increment(item.id)
                          }
                        ...
                        <IconButton
                          ...
                          onClick={() =>
                            items ? undefined : cart.decrement(item.id)
                          }
                          disabled={Boolean(items)}
                        >
                        ...
                        <IconButton
                          ...
                          onClick={() =>
                            items ? undefined : cart.remove(item.id)
                          }
                          disabled={Boolean(items)}
                        >
                          <CloseIcon fontSize="small" />
            ...
            <Box
              sx={{
                ...
                height: 48,
                background:
                  "linear-gradient(180deg, rgba(248,250,252,0) 0%, rgba(248,250,252,0.9) 60%, #f8fafc 100%)",
              }}
            />
          </Box>
