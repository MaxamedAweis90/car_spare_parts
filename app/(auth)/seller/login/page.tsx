      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-3xl bg-white shadow-[0_30px_80px_rgba(15,23,42,0.12)] md:grid md:grid-cols-2">
        <div className="px-8 py-10 sm:px-12 flex flex-col gap-6">
          <div className="text-left">
            ...
            <h1 className="mt-4 text-3xl font-extrabold text-slate-900">Sign in as Seller</h1>
            <p className="text-sm text-slate-600">Access your dashboard and manage your storefront.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm text-slate-600">
              <label className="inline-flex items-center gap-2">
                <input type="checkbox" className="h-4 w-4 rounded border-slate-300 text-[#1d4ed8] focus:ring-[#1d4ed8]" />
                <span>Remember me</span>
              </label>
              <a className="font-semibold text-[#1d4ed8] hover:underline" href="/auth/seller/login">
                Forgot password?
              </a>
            </div>
          ...
          <div className="text-sm text-slate-600">
            ...
            <a className="font-semibold text-[#1d4ed8] hover:underline" href="/auth/seller/register">
              Apply as seller
            </a>
          </div>
        </div>
        ...
        <div className="relative hidden md:block bg-[#1f4fe0]">
          ...
          <div className="relative flex h-full flex-col items-center justify-center gap-6 px-8 py-12 text-white">
            <div className="rounded-full bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em]">Seller tools</div>
            <h2 className="text-2xl font-extrabold">Manage your inventory and orders.</h2>
            <p className="max-w-sm text-sm text-white/85">Track performance, fulfill orders, and keep customers updated from one place.</p>
